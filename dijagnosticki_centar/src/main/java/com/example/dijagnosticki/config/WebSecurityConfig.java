...
import com.example.dijagnosticki.config.CustomUsernamePasswordAuthenticationProvider;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                .authorizeRequests()
                .antMatchers("/", "/admin", "/admin/**", "/home", "/register", "/assets/**", "/register", "/products", "/api/**").permitAll()
